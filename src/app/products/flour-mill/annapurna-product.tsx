        ...
        <div className="flex gap-10 items-center justify-center">
          ...
          <div className="basis-5/12">
            <div className="border-y-[1px] border-black py-10 flex flex-col leading-8	text-lg gap-8 text-[#333333] ">
              <p>
                The Flour Mill Annapurna is designed by keeping in view the
                basic requirement of the medium and large sized families with 2
                in 1 Chamber
              </p>
              <p>
                SS Heavy Bitter and Mirror Finished Front as well as Top Door.
                Its unique design makes it different from others due to large
                capacity and productivity in same frame of time.
              </p>
            </div>
          </div>
